    ...
    extends AlgorithmParameterGeneratorSpi
{
        ...
        extends JDKAlgorithmParameterGenerator
    {
        ...
        protected AlgorithmParameters engineGenerateParameters()
        {
            ...
            try
            {
                params = AlgorithmParameters.getInstance("DH", "BC2");
        ...
        extends JDKAlgorithmParameterGenerator
    {
        ...
        protected AlgorithmParameters engineGenerateParameters()
        {
            ...
            try
            {
                params = AlgorithmParameters.getInstance("DSA", "BC2");
        ...
        extends JDKAlgorithmParameterGenerator
    {
        ...
        protected AlgorithmParameters engineGenerateParameters()
        {
            ...
            try
            {
                params = AlgorithmParameters.getInstance("ElGamal", "BC2");
                params.init(new DHParameterSpec(p.getP(), p.getG(), l));
            }
            catch (Exception e)
            {
        ...
        extends JDKAlgorithmParameterGenerator
    {
        ...
        protected AlgorithmParameters engineGenerateParameters()
        {
            ...
            try
            {
                params = AlgorithmParameters.getInstance("DES", "BC2");
        ...
        extends JDKAlgorithmParameterGenerator
    {
        ...
        protected AlgorithmParameters engineGenerateParameters()
        {
            ...
            if (spec == null)
            {
                ...
                try
                {
                    params = AlgorithmParameters.getInstance("RC2", "BC2");
                    params.init(new IvParameterSpec(iv));
                }
                catch (Exception e)
                {
