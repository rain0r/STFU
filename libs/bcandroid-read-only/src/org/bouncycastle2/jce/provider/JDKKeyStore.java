    ...
    implements BCKeyStore
{
        ...
        throws IOException
    {
        ...
        try
        {
            CertificateFactory cFact = CertificateFactory.getInstance(type, "BC2");
        ...
        throws IOException
    {
        ...
        try
        {
            ...
            {
            case KEY_PRIVATE:
                return KeyFactory.getInstance(algorithm, "BC2").generatePrivate(spec);
            case KEY_PUBLIC:
                return KeyFactory.getInstance(algorithm, "BC2").generatePublic(spec);
            case KEY_SECRET:
                return SecretKeyFactory.getInstance(algorithm, "BC2").generateSecret(spec);
            default:
