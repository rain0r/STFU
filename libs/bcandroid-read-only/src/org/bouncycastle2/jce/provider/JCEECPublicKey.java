    ...
    implements ECPublicKey, org.bouncycastle2.jce.interfaces.ECPublicKey, ECPointEncoder
{
    ...
    public JCEECPublicKey(
        String              algorithm,
        org.bouncycastle2.jce.spec.ECPublicKeySpec     spec)
    {
        this.algorithm = algorithm;
        this.q = spec.getQ();
        ...
        else
        {
            if (q.getCurve() == null)
            {
                org.bouncycastle2.jce.spec.ECParameterSpec s = ProviderUtil.getEcImplicitlyCa();
    ...
    public org.bouncycastle2.math.ec.ECPoint getQ()
    {
        if (ecSpec == null)
        {
            if (q instanceof org.bouncycastle2.math.ec.ECPoint.Fp)
            {
                return new org.bouncycastle2.math.ec.ECPoint.Fp(null, q.getX(), q.getY());
            }
            else
            {
                return new org.bouncycastle2.math.ec.ECPoint.F2m(null, q.getX(), q.getY());
            }
        }
