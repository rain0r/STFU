...
public class CertPathValidatorUtilities
{
     ...
     *            {@link org.bouncycastle2.x509.X509Store  X509Store} objects.
            ...
            try
            {
                if (location.startsWith("ldap://"))
                {
                    ...
                    pkixParams.addAdditionalStore(X509Store.getInstance(
                        "CERTIFICATE/LDAP", params, "BC2"));
                    pkixParams.addAdditionalStore(X509Store.getInstance(
                        "CRL/LDAP", params, "BC2"));
                    pkixParams.addAdditionalStore(X509Store.getInstance(
                        "ATTRIBUTECERTIFICATE/LDAP", params, "BC2"));
                    pkixParams.addAdditionalStore(X509Store.getInstance(
                        "CERTIFICATEPAIR/LDAP", params, "BC2"));
                }
            }
            catch (Exception e)
            {
     ...
     *         {@link org.bouncycastle2.x509.X509AttributeCertificate} objects.
