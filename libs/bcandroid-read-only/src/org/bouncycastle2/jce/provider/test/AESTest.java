    ...
    extends BaseBlockCipherTest
{
        ...
        throws Exception
    {
        ...
        in = Cipher.getInstance("AES/ECB/NoPadding", "BC2");
        out = Cipher.getInstance("AES/ECB/NoPadding", "BC2");
        ...
        throws Exception
    {
        ...
        in = Cipher.getInstance("AES/EAX/NoPadding", "BC2");
        out = Cipher.getInstance("AES/EAX/NoPadding", "BC2");
        ...
        try
        {
            in = Cipher.getInstance("AES/EAX/PKCS5Padding", "BC2");
        ...
        throws Exception
    {
        ...
        in = Cipher.getInstance("AES/CCM/NoPadding", "BC2");
        out = Cipher.getInstance("AES/CCM/NoPadding", "BC2");
        ...
        try
        {
            in = Cipher.getInstance("AES/CCM/PKCS5Padding", "BC2");
        ...
        throws Exception
    {
        ...
        in = Cipher.getInstance("AES/GCM/NoPadding", "BC2");
        out = Cipher.getInstance("AES/GCM/NoPadding", "BC2");
        ...
        try
        {
            in = Cipher.getInstance("AES/GCM/PKCS5Padding", "BC2");
