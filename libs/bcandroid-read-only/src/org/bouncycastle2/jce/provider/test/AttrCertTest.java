...
import org.bouncycastle2.x509.AttributeCertificateHolder;
...
import org.bouncycastle2.x509.X509V2AttributeCertificateGenerator;
    ...
    extends SimpleTest
{
        ...
        throws Exception
    {
        ...
        KeyFactory  kFact = KeyFactory.getInstance("RSA", "BC2");
        ...
        X509AttributeCertificate aCert = gen.generate(privKey, "BC2");
        
        aCert.checkValidity();
        
        aCert.verify(pubKey, "BC2");
        ...
        throws Exception
    {
        ...
        aCert.verify(sCert.getPublicKey(), "BC2");
        ...
        aCert = gen.generate(privKey, "BC2");
