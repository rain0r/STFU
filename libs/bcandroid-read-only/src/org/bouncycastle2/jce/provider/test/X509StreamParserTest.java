...
import org.bouncycastle2.x509.X509StreamParser;
    ...
    extends SimpleTest
{
        ...
        throws Exception
    {
        ...
        parser = X509StreamParser.getInstance("AttributeCertificate", "BC2");
        ...
        parser = X509StreamParser.getInstance("Certificate", "BC2");
        ...
        //
        parser = X509StreamParser.getInstance("CertificatePair", "BC2");
