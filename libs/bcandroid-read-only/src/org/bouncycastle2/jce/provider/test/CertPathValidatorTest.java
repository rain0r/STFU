    ...
    extends SimpleTest
{
        ...
        throws Exception
    {
        ...
        CertPath cp = CertificateFactory.getInstance("X.509","BC2").generateCertPath(certchain);

        Set trust = new HashSet();
        trust.add(new TrustAnchor(caCert, null));

        CertPathValidator cpv = CertPathValidator.getInstance("PKIX","BC2");
        ...
        throws Exception
    {
        ...
        CertStore store = CertStore.getInstance("Collection", ccsp, "BC2");
        Calendar validDate = Calendar.getInstance();
        ...
        try
        {
            ...
            certchain.add(finalCert);
            certchain.add(interCert);
            cp = CertificateFactory.getInstance("X.509","BC2").generateCertPath(certchain);
            trust = new HashSet();
            trust.add(new TrustAnchor(rootCert, null));

            cpv = CertPathValidator.getInstance("PKIX","BC2");
