 ...
 +"Ime5LeGGU2iW3ieAv6es/FdMrwTKkqn5dhd3aL/itFg5oQbhyfXw5yw/QQ==");
   ...
   + "gQ7m3CMbZFfJ2cPu6QyarseXGYHmazoirH5lGjEo535c1g==");
    ...
    private void generationTest(int keySize, String keyName, String sigName, String provider)
        throws Exception
    {
        KeyPairGenerator kpg = KeyPairGenerator.getInstance(keyName, "BC2");
        ...
        throws Exception
    {
        ...
        KeyPairGenerator ecGostKpg = KeyPairGenerator.getInstance("ECGOST3410", "BC2");
    ...
    public void performTest()
        throws Exception
    {
        generationTest(512, "RSA", "SHA1withRSA", "BC2");       
        generationTest(512, "GOST3410", "GOST3411withGOST3410", "BC2");
