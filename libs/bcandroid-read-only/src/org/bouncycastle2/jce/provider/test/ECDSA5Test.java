...
import org.bouncycastle2.jce.ECKeyUtil;
    ...
    extends SimpleTest
{
        ...
        throws Exception
    {
        ...
        Signature s = Signature.getInstance("ECDSA", "BC2");
        KeyPairGenerator g = KeyPairGenerator.getInstance("ECDSA", "BC2");
    ...
    private void testKeyConversion()
        throws Exception
    {
        KeyPairGenerator kpGen = KeyPairGenerator.getInstance("ECDSA", "BC2");

        kpGen.initialize(new ECGenParameterSpec("prime192v1"));

        KeyPair pair = kpGen.generateKeyPair();

        PublicKey pubKey = ECKeyUtil.publicToExplicitParameters(pair.getPublic(), "BC2");
        ...
        PrivateKey privKey = ECKeyUtil.privateToExplicitParameters(pair.getPrivate(), "BC2");
