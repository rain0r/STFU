    ...
    extends SimpleTest
{
        ...
        throws Exception
    {
        ...
        KeyPairGenerator    g = KeyPairGenerator.getInstance("ECDH", "BC2");
        ...
        KeyAgreement aKeyAgree = KeyAgreement.getInstance("ECDHC", "BC2");
        ...
        KeyAgreement bKeyAgree = KeyAgreement.getInstance("ECDHC", "BC2");
        ...
        KeyFactory          keyFac = KeyFactory.getInstance("ECDH", "BC2");
        ...
        throws Exception
    {
        ...
        KeyPairGenerator    g = KeyPairGenerator.getInstance("ECGOST3410", "BC2");
        ...
        //
        byte[]              pubEnc = vKey.getEncoded();
        KeyFactory          keyFac = KeyFactory.getInstance("ECGOST3410", "BC2");
        X509EncodedKeySpec  pubX509 = new X509EncodedKeySpec(pubEnc);
        ECPublicKey         pubKey = (ECPublicKey)keyFac.generatePublic(pubX509);
