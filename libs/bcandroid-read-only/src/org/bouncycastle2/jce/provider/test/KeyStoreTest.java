    ...
    extends SimpleTest
{
        ...
        throws Exception
    {
        ...
        KeyStore store = KeyStore.getInstance(storeName, "BC2");
        ...
        //
        store = KeyStore.getInstance(storeName, "BC2");
        ...
        KeyFactory          keyFac = KeyFactory.getInstance(pubKey.getAlgorithm(), "BC2");
        X509EncodedKeySpec  pubX509 = new X509EncodedKeySpec(pubEnc);

        pubKey = (PublicKey)keyFac.generatePublic(pubX509);

        pubEnc = pubKey.getEncoded();
        keyFac = KeyFactory.getInstance(pubKey.getAlgorithm(), "BC2");
        ...
        keyFac = KeyFactory.getInstance(privKey.getAlgorithm(), "BC2");
        ...
        throws Exception
    {
        ...
        KeyPairGenerator gen = KeyPairGenerator.getInstance("RSA", "BC2");
