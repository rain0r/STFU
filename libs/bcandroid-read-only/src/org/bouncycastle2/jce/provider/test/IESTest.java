...
import org.bouncycastle2.jce.spec.IEKeySpec;
    ...
    extends SimpleTest
{
    ...
    public void performTest()
        throws Exception
    {
        KeyPairGenerator    g = KeyPairGenerator.getInstance("ECIES", "BC2");
        ...
        Cipher c1 = Cipher.getInstance("ECIES", "BC2");
        Cipher c2 = Cipher.getInstance("ECIES", "BC2");
        
        doTest(g, c1, c2);

        g = KeyPairGenerator.getInstance("ECIES", "BC2");
        ...
        c1 = Cipher.getInstance("IES", "BC2");
        c2 = Cipher.getInstance("IES", "BC2");
        
        g = KeyPairGenerator.getInstance("DH", "BC2");
