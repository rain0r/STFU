...
import org.bouncycastle2.jce.X509KeyUsage;
...
import org.bouncycastle2.x509.X509V2CRLGenerator;
    ...
    extends SimpleTest
{
        ...
        byte[]  bytes)
    {
        ...
        try
        {
            ...
            CertificateFactory  fact = CertificateFactory.getInstance("X.509", "BC2");
        ...
        throws Exception
    {
        ...
        KeyFactory  fact = KeyFactory.getInstance("RSA", "BC2");
        ...
        CertificateFactory     certFact = CertificateFactory.getInstance("X.509", "BC2");
        ...
        certFact = CertificateFactory.getInstance("X.509", "BC2");
    ...
    public void checkCreation3()
    {
        ...
        try
        {
            KeyFactory     fact = KeyFactory.getInstance("ECDSA", "BC2");
        ...
        try
        {
            ...
            cert = certGen.generate(privKey, "BC2");
            ...
            bIn = new ByteArrayInputStream(cert.getEncoded());
            fact = CertificateFactory.getInstance("X.509", "BC2");
        ...
        throws Exception
    {
        ...
        X509Certificate cert = certGen.generate(privKey, "BC2");
        ...
        Signature sig = Signature.getInstance(algorithm, "BC2");
    ...
    public void checkCRLCreation1()
        throws Exception
    {
        KeyPairGenerator     kpGen = KeyPairGenerator.getInstance("RSA", "BC2");
        ...
        X509CRL    crl = crlGen.generate(pair.getPrivate(), "BC2");
        ...
        throws Exception
    {
        ...
        X509CRL    newCrl = crlGen.generate(pair.getPrivate(), "BC2");
        ...
        //
        CertificateFactory cFact = CertificateFactory.getInstance("X.509", "BC2");
        ...
        throws Exception
    {
        ...
        X509Certificate baseCert = certGen.generate(privKey, "BC2");
       ...
       throws Exception
    {
        ...
        x509.verify(x509.getPublicKey(), "BC2");
