    ...
    extends SimpleTest
{
        ...
        throws Exception
    {
        ...
        KeyStore store = KeyStore.getInstance("PKCS12", "BC2");
        ...
        //
        store = KeyStore.getInstance("PKCS12", "BC2");
    ...
    private void basicStoreTest(PrivateKey privKey, Certificate[] chain, String type)
        throws Exception
    {
        KeyStore store = KeyStore.getInstance(type, "BC2");
        ...
        throws Exception
    {
        ...
        KeyStore store1 = KeyStore.getInstance("PKCS12", "BC2");

        store1.load(new ByteArrayInputStream(store1data), passwd);

        KeyStore store2 = KeyStore.getInstance("PKCS12", "BC2");
