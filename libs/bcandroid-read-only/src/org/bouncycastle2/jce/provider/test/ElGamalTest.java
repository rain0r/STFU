    ...
    extends SimpleTest
{
        ...
        throws Exception
    {
        ...
        Cipher  cipher = Cipher.getInstance("ElGamal", "BC2");
        ...
        Cipher  c1 = Cipher.getInstance("ElGamal", "BC2");
        Cipher  c2 = Cipher.getInstance("ElGamal", "BC2");
        ...
        KeyFactory              keyFac = KeyFactory.getInstance("ElGamal", "BC2");
        ...
        throws Exception
    {
        ...
        AlgorithmParameters a2 = AlgorithmParameters.getInstance("ElGamal", "BC2");
