...
public class X509LDAPCertStoreTest extends SimpleTest
{
    ...
    {
        CertStore cs = CertStore.getInstance("X509LDAP", params1, "BC2");
        ...
        cs = CertStore.getInstance("X509LDAP", params2, "BC2");
        ...
        cs = CertStore.getInstance("X509LDAP", params3, "BC2");
        sl = new X509CertSelector();
        xcert = (X509Certificate)cf
    ...
    {
        X509Store cs = X509Store.getInstance("CERTIFICATE/LDAP", params1, "BC2");
        ...
        cs = X509Store.getInstance("CRL/LDAP", params1, "BC2");
        ...
        cs = X509Store.getInstance("CERTIFICATE/LDAP", params2, "BC2");
        ...
        cs = X509Store.getInstance("CERTIFICATE/LDAP", params3, "BC2");
        sl = new X509CertStoreSelector();
        xcert = (X509Certificate)cf
            .generateCertificate(new ByteArrayInputStream(cert3));
        sl.setCertificate(xcert);
