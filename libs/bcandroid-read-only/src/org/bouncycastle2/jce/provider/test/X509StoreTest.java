    ...
    extends SimpleTest
{
        ...
        throws Exception
    {
        ...
        X509Store certStore = X509Store.getInstance("CertificatePair/Collection", ccsp, "BC2");
        ...
        throws Exception
    {
        ...
        X509CollectionStoreParameters ccsp = new X509CollectionStoreParameters(certList);
        X509Store certStore = X509Store.getInstance("Certificate/Collection", ccsp, "BC2");
        ...
        X509Store store = X509Store.getInstance("CRL/Collection", ccsp, "BC2");
        ...
        store = X509Store.getInstance("AttributeCertificate/Collection", ccsp, "BC2");
