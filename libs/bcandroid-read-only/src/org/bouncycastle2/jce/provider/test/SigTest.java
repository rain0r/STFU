    ...
    extends SimpleTest
{
    ...
    {
        MessageDigest sha1 = MessageDigest.getInstance("SHA1", "BC2");
        Cipher signer = Cipher.getInstance("RSA/ECB/PKCS1Padding", "BC2");
        ...
        Signature verifier = Signature.getInstance("SHA1WithRSA", "BC2");
    ...
    public void performTest()
        throws Exception
    {   
        Signature           sig = Signature.getInstance("SHA1WithRSAEncryption", "BC2");
        KeyPairGenerator    fact;
        KeyPair             keyPair;
        byte[]              data = { 1, 2, 3, 4, 5, 6, 7, 8, 9, 0 };

        fact = KeyPairGenerator.getInstance("RSA", "BC2");
        ...
        sig = Signature.getInstance("MD2WithRSAEncryption", "BC2");
        ...
        sig = Signature.getInstance("MD5WithRSAEncryption", "BC2");
        ...
        sig = Signature.getInstance("RIPEMD160WithRSAEncryption", "BC2");
        ...
        // RIPEMD-128
        //
        sig = Signature.getInstance("RIPEMD128WithRSAEncryption", "BC2");
        ...
        // RIPEMD256
        //
        sig = Signature.getInstance("RIPEMD256WithRSAEncryption", "BC2");
        ...
        // SHA-224
        //
        sig = Signature.getInstance("SHA224WithRSAEncryption", "BC2");
        ...
        // SHA-256
        //
        sig = Signature.getInstance("SHA256WithRSAEncryption", "BC2");
        ...
        // SHA-384
        //
        sig = Signature.getInstance("SHA384WithRSAEncryption", "BC2");
        ...
        // SHA-512
        //
        sig = Signature.getInstance("SHA512WithRSAEncryption", "BC2");
        ...
        // ISO Sigs.
        //
        sig = Signature.getInstance("MD5WithRSA/ISO9796-2", "BC2");
        ...
        sig = Signature.getInstance("SHA1WithRSA/ISO9796-2", "BC2");
        ...
        sig = Signature.getInstance("RIPEMD160WithRSA/ISO9796-2", "BC2");
        ...
        KeyFactory  f = KeyFactory.getInstance("RSA", "BC2");
