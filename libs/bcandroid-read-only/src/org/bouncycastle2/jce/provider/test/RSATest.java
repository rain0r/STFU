    ...
    extends SimpleTest
{
        ...
        throws Exception
    {
        ...
        fact = KeyFactory.getInstance("RSA", "BC2");
        ...
        // PKCS1 V 1.5
        //
        c = Cipher.getInstance("RSA/ECB/PKCS1Padding", "BC2");
        ...
        // OAEP - SHA1
        //
        c = Cipher.getInstance("RSA/NONE/OAEPPadding", "BC2");
        ...
        c = Cipher.getInstance("RSA/NONE/OAEPWithSHA1AndMGF1Padding", "BC2");
        ...
        // OAEP - SHA224
        //
        c = Cipher.getInstance("RSA/NONE/OAEPWithSHA224AndMGF1Padding", "BC2");
        ...
        // OAEP - SHA 256
        //
        c = Cipher.getInstance("RSA/NONE/OAEPWithSHA256AndMGF1Padding", "BC2");
        ...
        // OAEP - SHA 384
        //
        c = Cipher.getInstance("RSA/NONE/OAEPWithSHA384AndMGF1Padding", "BC2");
        ...
        // OAEP - MD5
        //
        c = Cipher.getInstance("RSA/NONE/OAEPWithMD5AndMGF1Padding", "BC2");
        ...
        c = Cipher.getInstance("RSA/NONE/ISO9796-1Padding", "BC2");
        ...
        KeyPairGenerator keyPairGen =
                KeyPairGenerator.getInstance("RSA", "BC2");
        ...
        // comparison check
        //
        KeyFactory keyFact = KeyFactory.getInstance("RSA", "BC2");
        ...
        throws Exception
    {
        ...
        Cipher bcCipher = Cipher.getInstance("RSA/ECB/OAEPWith" + digest + "AndMGF1Padding", "BC2");
        ...
        PrivateKey privKey, PublicKey pubKey, SecureRandom random) throws Exception
    {
        ...
        Signature normalSig = Signature.getInstance(sigName, "BC2");
        normalSig.initSign(privKey);
        normalSig.update(sampleMessage);
        byte[] normalResult = normalSig.sign();

        MessageDigest digest = MessageDigest.getInstance(digestOID.getId(), "BC2");
        byte[] hash = digest.digest(sampleMessage);
        byte[] digInfo = derEncode(digestOID, hash);

        Signature rawSig = Signature.getInstance("RSA", "BC2");
