    ...
    extends SimpleTest
{
    ...
    private void aliasTest(SecretKey key, String primary, String[] aliases)
        throws Exception
    {
        Mac mac = Mac.getInstance(primary, "BC2");
        ...
        {
            mac = Mac.getInstance(aliases[i], "BC2");
        ...
        throws Exception
    {
        ...
        mac = Mac.getInstance("DESMac", "BC2");
        ...
        //
        mac = Mac.getInstance("DESMac/CFB8", "BC2");
        ...
        mac = Mac.getInstance("ISO9797ALG3", "BC2");
        ...
        mac = Mac.getInstance("DESEDE64", "BC2");
