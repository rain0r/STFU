    ...
    extends SimpleTest
{
        ...
        throws Exception
    {
        ...
        if (name.indexOf('/') < 0)
        {
            kGen = KeyGenerator.getInstance(name, "BC2");
        }
        else
        {
            kGen = KeyGenerator.getInstance(name.substring(0, name.indexOf('/')), "BC2");
        }

        Cipher                  in = Cipher.getInstance(name, "BC2");
        Cipher                  out = Cipher.getInstance(name, "BC2");
        ...
        String  name)
    {
        try
        {
            ...
            Cipher ecipher = Cipher.getInstance(name, "BC2");
            ...
            try
            {
                Cipher c = Cipher.getInstance(name, "BC2");
