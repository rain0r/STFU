    ...
    extends SimpleTest
{
        ...
        byte[]      output)
    {
        ...
        try
        {
            ...
            keyGen = KeyGenerator.getInstance(baseAlgorithm, "BC2");
            ...
            in = Cipher.getInstance(algorithm, "BC2");
            out = Cipher.getInstance(algorithm, "BC2");
    ...
    private void testExceptions()
    {
        ...
        try
        {
            skF = SecretKeyFactory.getInstance("DESede", "BC2");
        }
        catch (Exception e)
        {
        ...
        try
        {
            KeyGenerator kg = KeyGenerator.getInstance("DESede", "BC2");
            try
            {
        ...
        try
        {
            ...
            Cipher cipher = Cipher.getInstance("DES/CBC/NoPadding", "BC2");
        ...
        try
        {
            ...
            SecretKeySpec cipherKey = new SecretKeySpec(rawDESKey, "DES");
            Cipher cipher = Cipher.getInstance("DES/ECB/NoPadding", "BC2");
            try
            {
                // According specification engineInit(int opmode, Key key,
        ...
        try
        {
            ...
            SecretKeySpec cipherKey = new SecretKeySpec(rawDESKey, "DES");
            Cipher ecipher = Cipher.getInstance("DES/ECB/PKCS5Padding", "BC2");
        ...
        try
        {
            AlgorithmParameters algParams = AlgorithmParameters.getInstance("DES", "BC2");
        ...
        try
        {
            ...
            try
            {
                Cipher c = Cipher.getInstance("DES", "BC2");
    ...
    public void performTest()
    {
        ...
        try
        {
            Cipher c = Cipher.getInstance("AES/CTS/NoPadding", "BC2");
