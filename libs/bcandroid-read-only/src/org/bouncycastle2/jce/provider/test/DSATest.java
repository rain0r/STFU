    ...
    extends SimpleTest
{
        ...
        throws Exception
    {
        ...
        s = Signature.getInstance("DSA", "BC2");
        ...
        //
        KeyFactory          f = KeyFactory.getInstance("DSA", "BC2");
        ...
        throws Exception
    {
        ...
        KeyPairGenerator kpGen = KeyPairGenerator.getInstance("DSA", "BC2");

        kpGen.initialize(512);

        KeyPair          kp = kpGen.generateKeyPair();

        Signature        sig = Signature.getInstance("NONEwithDSA", "BC2");
        ...
        throws Exception
    {
        ...
        Signature           sgr = Signature.getInstance("ECDSA", "BC2");
        KeyFactory          f = KeyFactory.getInstance("ECDSA", "BC2");
        ...
        throws Exception
    {
        ...
        Signature           sgr = Signature.getInstance("NONEwithECDSA", "BC2");
        KeyFactory          f = KeyFactory.getInstance("ECDSA", "BC2");
        PrivateKey          sKey = f.generatePrivate(priKey);
        PublicKey           vKey = f.generatePublic(pubKey);
...
//        BigInteger s = new BigInteger("197030374000731686738334997654997227052849804072198819102649413465737174");
        ...
        Signature   sgr = Signature.getInstance(algorithm, "BC2");
        KeyFactory  f = KeyFactory.getInstance("ECDSA", "BC2");
        PrivateKey  sKey = f.generatePrivate(priKeySpec);
        PublicKey   vKey = f.generatePublic(pubKeySpec);
        byte[]      message = new byte[] { (byte)'a', (byte)'b', (byte)'c' };
        ...
        sgr = Signature.getInstance(oid.getId(), "BC2");
    ...
    private void testGeneration()
        throws Exception
    {
        Signature           s = Signature.getInstance("DSA", "BC2");
        KeyPairGenerator    g = KeyPairGenerator.getInstance("DSA", "BC2");
        byte[]              data = { 1, 2, 3, 4, 5, 6, 7, 8, 9, 0 };
        ...
        //
        s = Signature.getInstance("ECDSA", "BC2");
        g = KeyPairGenerator.getInstance("ECDSA", "BC2");
    ...
    private void testParameters()
        throws Exception
    {
        AlgorithmParameterGenerator a = AlgorithmParameterGenerator.getInstance("DSA", "BC2");
        a.init(512, random);
        AlgorithmParameters params = a.generateParameters();
        
        byte[] encodeParams = params.getEncoded();
        
        AlgorithmParameters a2 = AlgorithmParameters.getInstance("DSA", "BC2");
