    ...
    extends SimpleTest
{
        ...
        throws Exception
    {
        ...
        KeyPairGenerator keyGen = KeyPairGenerator.getInstance(algName, "BC2");
        ...
        KeyFactory          keyFac = KeyFactory.getInstance(algName, "BC2");
        ...
        // three party test
        //
        KeyPairGenerator aPairGen = KeyPairGenerator.getInstance(algName, "BC2");
        aPairGen.initialize(spec);
        KeyPair aPair = aPairGen.generateKeyPair();

        KeyPairGenerator bPairGen = KeyPairGenerator.getInstance(algName, "BC2");
        bPairGen.initialize(spec);
        KeyPair bPair = bPairGen.generateKeyPair();

        KeyPairGenerator cPairGen = KeyPairGenerator.getInstance(algName, "BC2");
        cPairGen.initialize(spec);
        KeyPair cPair = cPairGen.generateKeyPair();

        KeyAgreement aKeyAgree = KeyAgreement.getInstance(algName, "BC2");
        aKeyAgree.init(aPair.getPrivate());

        KeyAgreement bKeyAgree = KeyAgreement.getInstance(algName, "BC2");
        bKeyAgree.init(bPair.getPrivate());

        KeyAgreement cKeyAgree = KeyAgreement.getInstance(algName, "BC2");
        ...
        throws Exception
    {
        ...
        KeyPairGenerator keyGen = KeyPairGenerator.getInstance("DH", "BC2");
        ...
        KeyAgreement aKeyAgree = KeyAgreement.getInstance("DH", "BC2");
        ...
        KeyAgreement bKeyAgree = KeyAgreement.getInstance("DH", "BC2");
    ...
    private void testRandom(
        ...
        throws Exception
    {
        AlgorithmParameterGenerator a = AlgorithmParameterGenerator.getInstance("DH", "BC2");
        a.init(size, new SecureRandom());
        AlgorithmParameters params = a.generateParameters();

        byte[] encodeParams = params.getEncoded();

        AlgorithmParameters a2 = AlgorithmParameters.getInstance("DH", "BC2");
    ...
    private void testECDH(String algorithm)
        throws Exception
    {
        KeyPairGenerator    g = KeyPairGenerator.getInstance(algorithm, "BC2");
        ...
        KeyAgreement aKeyAgree = KeyAgreement.getInstance(algorithm, "BC2");
        ...
        KeyAgreement bKeyAgree = KeyAgreement.getInstance(algorithm, "BC2");
        ...
        //
        byte[]              pubEnc = aKeyPair.getPublic().getEncoded();
        KeyFactory          keyFac = KeyFactory.getInstance(algorithm, "BC2");
        X509EncodedKeySpec  pubX509 = new X509EncodedKeySpec(pubEnc);
        ...
        throws Exception
    {
        ...
        KeyAgreement keyAgreement = KeyAgreement.getInstance("DH", "BC2");
