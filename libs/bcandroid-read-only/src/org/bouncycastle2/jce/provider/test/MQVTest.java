    ...
    extends SimpleTest
{
    ...
    private void testECMQV()
        throws Exception
    {
        KeyPairGenerator g = KeyPairGenerator.getInstance("ECMQV", "BC2");
        ...
        KeyAgreement uAgree = KeyAgreement.getInstance("ECMQV", "BC2");
        ...
        KeyAgreement vAgree = KeyAgreement.getInstance("ECMQV", "BC2");
