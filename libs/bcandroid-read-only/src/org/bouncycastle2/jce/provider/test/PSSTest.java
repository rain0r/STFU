    ...
    extends SimpleTest
{
    ...
    public void performTest() throws Exception
    {
        ...
        Signature s = Signature.getInstance("SHA1withRSA/PSS", "BC2");
        ...
        s = Signature.getInstance("SHA1withRSAandMGF1", "BC2");
        ...
        s = Signature.getInstance("SHA256withRSA/PSS", "BC2");
        ...
        s = Signature.getInstance("SHA256withRSAandMGF1", "BC2");
        ...
        //
        s = Signature.getInstance("SHA512withRSAandMGF1", "BC2");
            ...
            PrivateKey privKey, PublicKey pubKey, SecureRandom random) throws Exception
    {
        ...
        Signature rawSig = Signature.getInstance("RAWRSASSA-PSS", "BC2");
