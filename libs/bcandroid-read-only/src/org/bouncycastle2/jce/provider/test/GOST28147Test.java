    ...
    extends SimpleTest
{
        ...
        throws Exception
    {
        ...
        in = Cipher.getInstance("GOST28147/ECB/NoPadding", "BC2");
        out = Cipher.getInstance("GOST28147/ECB/NoPadding", "BC2");
        ...
        throws Exception
    {
        ...
        in = Cipher.getInstance("GOST28147/CFB8/NoPadding", "BC2");
        out = Cipher.getInstance("GOST28147/CFB8/NoPadding", "BC2");
    ...
    private void oidTest()
    {
        ...
        try
        {
            ...
            {
                Cipher c1 = Cipher.getInstance(oids[i], "BC2");
                Cipher c2 = Cipher.getInstance(names[i], "BC2");
                KeyGenerator kg = KeyGenerator.getInstance(oids[i], "BC2");
