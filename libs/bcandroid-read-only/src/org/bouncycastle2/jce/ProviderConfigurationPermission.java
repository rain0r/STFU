 ...
 * Examples:
 * <ul>
 * <li>ProviderConfigurationPermission("BC2"); // enable all permissions</li>
 * <li>ProviderConfigurationPermission("BC2", "threadLocalEcImplicitlyCa"); // enable thread local only</li>
 * <li>ProviderConfigurationPermission("BC2", "ecImplicitlyCa"); // enable global setting only</li>
 * <li>ProviderConfigurationPermission("BC2", "threadLocalEcImplicitlyCa, ecImplicitlyCa"); // enable both explicitly</li>
 * </ul>
 * <p>
