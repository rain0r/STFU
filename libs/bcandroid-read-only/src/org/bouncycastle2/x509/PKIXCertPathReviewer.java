...
import org.bouncycastle2.i18n.LocaleString;
...
import org.bouncycastle2.jce.provider.PKIXNameConstraintValidator;
import org.bouncycastle2.jce.provider.PKIXNameConstraintValidatorException;
import org.bouncycastle2.jce.provider.PKIXPolicyNode;
        ...
        throws CertPathReviewerException
    {
        ...
        if (crl != null)
        {
            ...
            if (workingPublicKey != null)
            {
                try
                {
                    crl.verify(workingPublicKey, "BC2");
                }
                catch (Exception e)
                {
