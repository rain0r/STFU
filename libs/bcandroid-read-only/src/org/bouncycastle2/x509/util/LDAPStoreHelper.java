 ...
 * {@link org.bouncycastle2.jce.X509LDAPCertStoreParameters} with the given
 * information of the subject (for all kind of certificates) or issuer (for
 * CRLs), respectively, if a {@link org.bouncycastle2.x509.X509CertStoreSelector} or
 * {@link org.bouncycastle2.x509.X509AttributeCertificate} is given with that
 * details.
 * <p/>
...
public class LDAPStoreHelper
{
     ...
     * {@link org.bouncycastle2.x509.X509CertStoreSelector} of the given
     * selector.
     *
     * @param xselector             The selector with the search criteria.
