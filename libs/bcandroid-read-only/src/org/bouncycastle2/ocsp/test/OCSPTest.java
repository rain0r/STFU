package org.bouncycastle2.ocsp.test;
...
import org.bouncycastle2.ocsp.BasicOCSPRespGenerator;
...
import org.bouncycastle2.ocsp.OCSPRespGenerator;
import org.bouncycastle2.ocsp.Req;
    ...
    extends SimpleTest
{
        ...
        throws Exception
    {
        ...
        X509Certificate[] certs = req.getCerts("BC2");
        ...
        req = gen.generate("SHA1withECDSA", signKP.getPrivate(), chain, "BC2");
        ...
        if (!req.verify(signKP.getPublic(), "BC2"))
        {
        ...
        if (!newReq.verify(signKP.getPublic(), "BC2"))
        {
        ...
        BasicOCSPResp resp = respGen.generate("SHA1withECDSA", signKP.getPrivate(), chain, new Date(), "BC2");
    }
        ...
        throws Exception
    {
        ...
        req = gen.generate("SHA1withRSA", signKP.getPrivate(), chain, "BC2");
        ...
        BasicOCSPResp resp = respGen.generate("SHA1withRSA", signKP.getPrivate(), chain, new Date(), "BC2");
        ...
        throws Exception
    {
        ...
        X509Certificate cert = ocspRequest.getCerts("BC2")[0];
        if (!ocspRequest.verify(cert.getPublicKey(), "BC2"))
        {
        ...
        throws Exception
    {
        ...
        chain = brep.getCerts("BC2");

        if (!brep.verify(chain[0].getPublicKey(), "BC2"))
        {
