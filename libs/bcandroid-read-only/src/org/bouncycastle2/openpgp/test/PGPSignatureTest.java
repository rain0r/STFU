    ...
    extends SimpleTest
{
        ...
        throws Exception
    {
        ...
        PGPPrivateKey pgpPrivKey = secretKey.extractPrivateKey(rsaPass, "BC2");
        ...
        sig.initVerify(secretKey.getPublicKey(), "BC2");
        ...
        PGPPrivateKey pgpPrivDSAKey = secretDSAKey.extractPrivateKey(dsaPass, "BC2");
        
        sGen = new PGPSignatureGenerator(PublicKeyAlgorithmTags.DSA, HashAlgorithmTags.SHA1, "BC2");
        ...
        sig.initVerify(secretDSAKey.getPublicKey(), "BC2");
        ...
        pgpPrivKey = secretKey.extractPrivateKey(dsaPass, "BC2");
    ...
    {            
        ...
        PGPSignatureGenerator sGen = new PGPSignatureGenerator(encAlgorithm, hashAlgorithm, "BC2");
    ...
    private void testTextSig(
        ...
        throws Exception
    {            
        PGPSignatureGenerator sGen = new PGPSignatureGenerator(encAlgorithm, HashAlgorithmTags.SHA1, "BC2");  
        ByteArrayOutputStream bOut = new ByteArrayOutputStream();
        ...
        throws Exception
    {
        ByteArrayOutputStream   bOut = new ByteArrayOutputStream();
        ByteArrayInputStream    testIn = new ByteArrayInputStream(TEST_DATA);
        PGPV3SignatureGenerator sGen = new PGPV3SignatureGenerator(encAlgorithm, hashAlgorithm, "BC2");
    ...
    private void testTextSigV3(
        ...
        throws Exception
    {            
        PGPV3SignatureGenerator sGen = new PGPV3SignatureGenerator(encAlgorithm, HashAlgorithmTags.SHA1, "BC2");
        ByteArrayOutputStream   bOut = new ByteArrayOutputStream();
        ByteArrayInputStream    testIn = new ByteArrayInputStream(data);
