...
import org.bouncycastle2.bcpg.PublicKeyAlgorithmTags;
...
import org.bouncycastle2.openpgp.PGPUserAttributeSubpacketVector;
import org.bouncycastle2.openpgp.PGPUserAttributeSubpacketVectorGenerator;
    ...
    extends SimpleTest
{
        ...
        throws Exception
    {
        ...
        PGPEncryptedDataGenerator encGen = new PGPEncryptedDataGenerator(SymmetricKeyAlgorithmTags.AES_128, true, new SecureRandom(), "BC2");
        ...
        InputStream clear = encP.getDataStream(pgpPrivKey, "BC2");
        ...
        clear = encPbe.getDataStream("password".toCharArray(), "BC2");
        ...
        throws Exception
    {
        ...
        PGPSignatureGenerator sGen = new PGPSignatureGenerator(PublicKeyAlgorithmTags.RSA_GENERAL, HashAlgorithmTags.SHA1, "BC2");

        sGen.initSign(PGPSignature.POSITIVE_CERTIFICATION, pgpSec.getSecretKey().extractPrivateKey(pass, "BC2"));
        ...
        throws Exception
    {
        ...
        pubKey = pgpPub.getPublicKey().getKey("BC2");
        ...
        sig.initVerify(pgpPub.getPublicKey(), "BC2");
        ...
        PublicKey            pubKeyV3 = pgpPub.getPublicKey().getKey("BC2");
        ...
        if (!noIDEA())
        {
            ...
            PGPPrivateKey           pgpPrivKey = pgpPriv.getSecretKey().extractPrivateKey(passP, "BC2");
        ...
        PGPPrivateKey pgpPrivKey = pgpPriv.getSecretKey().extractPrivateKey(pass, "BC2");
        ...
        // test encryption
        //
        Cipher c = Cipher.getInstance("RSA", "BC2");
        ...
        ops.initVerify(pgpPub.getPublicKey(ops.getKeyID()), "BC2");
        ...
        pgpPrivKey = pgpPriv.getSecretKey(encP.getKeyID()).extractPrivateKey(pass, "BC2");
        ...
        PGPEncryptedDataGenerator    cPk = new PGPEncryptedDataGenerator(SymmetricKeyAlgorithmTags.CAST5, new SecureRandom(), "BC2");            
        ...
        if (encP.getSymmetricAlgorithm(pgpPrivKey, "BC2") != SymmetricKeyAlgorithmTags.CAST5)
        {
            fail("symmetric algorithm mismatch");
        }

        clear = encP.getDataStream(pgpPrivKey, "BC2");
        ...
        cPk = new PGPEncryptedDataGenerator(SymmetricKeyAlgorithmTags.CAST5, new SecureRandom(), "BC2");            
        ...
        KeyPairGenerator    kpg = KeyPairGenerator.getInstance("RSA", "BC2");
    
        kpg.initialize(1024);
    
        KeyPair                    kp = kpg.generateKeyPair();

        PGPSecretKey    secretKey = new PGPSecretKey(PGPSignature.DEFAULT_CERTIFICATION, PublicKeyAlgorithmTags.RSA_GENERAL, kp.getPublic(), kp.getPrivate(), new Date(), "fred", SymmetricKeyAlgorithmTags.CAST5, passPhrase, null, null, new SecureRandom(), "BC2");
        ...
        pgpPrivKey = secretKey.extractPrivateKey(passPhrase, "BC2");
        ...
        sGen.initSign(PGPSignature.KEY_REVOCATION, secretKey.extractPrivateKey(passPhrase, "BC2"));
        ...
        secretKey = new PGPSecretKey(PGPSignature.DEFAULT_CERTIFICATION, PublicKeyAlgorithmTags.RSA_GENERAL, kp.getPublic(), kp.getPrivate(), new Date(), "fred", SymmetricKeyAlgorithmTags.AES_256, passPhrase, null, null, new SecureRandom(), "BC2");
    
        secretKey.extractPrivateKey(passPhrase, "BC2");
        ...
        secretKey = PGPSecretKey.copyWithNewPassword(secretKey, passPhrase, newPass.toCharArray(), secretKey.getKeyEncryptionAlgorithm(), new SecureRandom(), "BC2");
        
        secretKey.extractPrivateKey(newPass.toCharArray(), "BC2");
        ...
        pgpPrivKey = secretKey.extractPrivateKey(newPass.toCharArray(), "BC2");
        ...
        sGen = new PGPSignatureGenerator(PublicKeyAlgorithmTags.RSA_GENERAL, HashAlgorithmTags.SHA1, "BC2");
        ...
        ops.initVerify(secretKey.getPublicKey(), "BC2");
        ...
        PGPV3SignatureGenerator    sGenV3 = new PGPV3SignatureGenerator(PGPPublicKey.RSA_GENERAL, PGPUtil.SHA1, "BC2");
        ...
        pgpPrivKey = secretKey.extractPrivateKey(pgp8Pass, "BC2");
