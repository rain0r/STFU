    ...
    extends SimpleTest
{
        ...
        throws Exception
    {
        ...
        while (rIt.hasNext())
        {
            ...
            while (it.hasNext())
            {
                ...
                k.extractPrivateKey(sec3pass1, "BC2");
            }
        ...
        throws Exception
    {
        ...
        while (rIt.hasNext())
        {
            ...
            while (it.hasNext())
            {
                ...
                k.extractPrivateKey(sec5pass1, "BC2");
            }
        ...
        throws Exception
    {
        ...
        while (rIt.hasNext())
        {
            ...
            while (it.hasNext())
            {
                ...
                k.extractPrivateKey(sec8pass, "BC2");
            }
    ...
    { 
        ...
        while (rIt.hasNext())
        {
            ...
            while (it.hasNext())
            {
                ...
                PGPPrivateKey   pKey = k.extractPrivateKey(sec9pass, "BC2");
        ...
        throws Exception
    {
        ...
        PGPKeyRingGenerator    keyRingGen = new PGPKeyRingGenerator(PGPSignature.POSITIVE_CERTIFICATION, dsaKeyPair,
                "test", PGPEncryptedData.AES_256, passPhrase, null, null, new SecureRandom(), "BC2");
    
        keyRingGen.addSubKey(elgKeyPair);
    
        PGPSecretKeyRing       keyRing = keyRingGen.generateSecretKeyRing();
        
        keyRing.getSecretKey().extractPrivateKey(passPhrase, "BC2");
    ...
    {
        char[]              passPhrase = "hello".toCharArray();
        KeyPairGenerator    rsaKpg = KeyPairGenerator.getInstance("RSA", "BC2");
        ...
        throws Exception
    {
        ...
        PGPKeyRingGenerator    keyRingGen = new PGPKeyRingGenerator(PGPSignature.POSITIVE_CERTIFICATION, dsaKeyPair,
                "test", PGPEncryptedData.AES_256, passPhrase, true, null, null, new SecureRandom(), "BC2");
        ...
        throws Exception
    {
        ...
        if (rIt.hasNext())
        {
            ...
            while (it.hasNext())
            {
                ...
                // this should succeed
                PGPPrivateKey privTmp = pgpKey.extractPrivateKey(null, "BC2");
            }
        }
    }
