    ...
    extends SimpleTest
{
        ...
        throws Exception
    {
        ...
        PGPSignatureGenerator   sGen = new PGPSignatureGenerator(PublicKeyAlgorithmTags.DSA, HashAlgorithmTags.SHA1, "BC2");
    ...
    {
        String file = null;
        KeyFactory fact = KeyFactory.getInstance("DSA", "BC2");
        ...
        pgpPrivKey = sKey.getSecretKey().extractPrivateKey(passPhrase, "BC2");
        ...
        pgpPrivKey = sKey.getSecretKey().extractPrivateKey(pass, "BC2");
        ...
        // use of PGPKeyPair
        //
        KeyPairGenerator    kpg = KeyPairGenerator.getInstance("DSA", "BC2");
