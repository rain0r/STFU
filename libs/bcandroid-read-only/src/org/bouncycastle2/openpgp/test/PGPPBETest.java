    ...
    extends SimpleTest
{
        ...
        throws Exception
    {
        ...
        InputStream clear = pbe.getDataStream(pass, "BC2");
        ...
        throws Exception
    {
        ...
        PGPEncryptedDataGenerator    cPk = new PGPEncryptedDataGenerator(PGPEncryptedData.CAST5, new SecureRandom(), "BC2");
        ...
        cPk = new PGPEncryptedDataGenerator(PGPEncryptedData.CAST5, new SecureRandom(), "BC2");
        ...
        cbOut = new ByteArrayOutputStream();
        cPk = new PGPEncryptedDataGenerator(PGPEncryptedData.CAST5, rand, "BC2");
        ...
        //
        cbOut = new ByteArrayOutputStream();
        cPk = new PGPEncryptedDataGenerator(PGPEncryptedData.CAST5, true, rand, "BC2");
        ...
        InputStream clear = pbe.getDataStream("password".toCharArray(), "BC2");
