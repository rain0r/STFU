    ...
    extends SimpleTest
{
        ...
        throws Exception
    {
        try
        {
            ...
            PGPUtil.setDefaultProvider("BC2");
            ...
            PGPPrivateKey        pgpPrivKey = sKey.getSecretKey().extractPrivateKey(pass, "BC2");
            ...
            PGPSignatureGenerator    sGen = new PGPSignatureGenerator(PGPPublicKey.DSA, PGPUtil.SHA1, "BC2");
            ...
            Cipher c = Cipher.getInstance("ElGamal/None/PKCS1Padding", "BC2");
            ...
            pgpPrivKey = sKey.getSecretKey(pgpKeyID).extractPrivateKey(pass, "BC2");
            ...
            //
            ops.initVerify(pgpPub.getPublicKey(), "BC2");
            ...
            PGPEncryptedDataGenerator    cPk = new PGPEncryptedDataGenerator(SymmetricKeyAlgorithmTags.TRIPLE_DES, new SecureRandom(), "BC2");            
            ...
            KeyPairGenerator       kpg = KeyPairGenerator.getInstance("ElGamal", "BC2");
            ...
            for (int pSize = 257; pSize < 264; ++pSize)
            {
                ...
                AlgorithmParameterGenerator a = AlgorithmParameterGenerator.getInstance("ElGamal", "BC2");
                a.init(pSize, new SecureRandom());
                AlgorithmParameters params = a.generateParameters();

                DHParameterSpec elP = (DHParameterSpec)params.getParameterSpec(DHParameterSpec.class);
                KeyPairGenerator keyGen = KeyPairGenerator.getInstance("ElGamal", "BC2");
                ...
                cPk = new PGPEncryptedDataGenerator(SymmetricKeyAlgorithmTags.CAST5, random, "BC2");
